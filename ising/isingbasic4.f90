	...
	open(unit=11,file="M_t_32_03.dat")
	
	jj=1.0; beta=10; nsize=20; tfinal=100
	
	!_____Random filling of sites with up or down spins________________
	...
	!________________lattice rolling___________________________________
	...
	!___________________________Initial energy___________________________
	...
	!_____________________________Monte Carlo______________________________
	...
	do t=0,tfinal
		...
		write(11,*) t,real(magnetization)/real(nsize*nsize)
	end do
